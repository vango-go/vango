...
// ===========================================================================
// EXAMPLE CODE - Database Repository Stubs
// ===========================================================================
//
// This file contains placeholder repository implementations generated by
// 'vango create --with-db'. These are NOT connected to a real database.
//
// TO USE A REAL DATABASE:
// 1. Add your database driver (e.g., github.com/lib/pq for PostgreSQL)
// 2. Initialize a connection pool in your main.go
// 3. Replace these stub implementations with actual queries
//
// See: https://vango.dev/docs/database for complete examples
// ===========================================================================
...
// Projects is an example repository stub.
// EXAMPLE: Replace with your database implementation.
var Projects = &projectsRepo{}

type projectsRepo struct{}

// Find returns a sample project. EXAMPLE: Replace with database query.
func (r *projectsRepo) Find(id int) (*Project, error) {
	// EXAMPLE: Replace with your database query
	// Example with database/sql:
	//   row := db.QueryRow("SELECT id, name, description FROM projects WHERE id = $1", id)
	//   var p Project
...
// Users is an example repository stub.
// EXAMPLE: Replace with your database implementation.
var Users = &usersRepo{}

type usersRepo struct{}

// All returns an empty slice. EXAMPLE: Replace with database query.
func (r *usersRepo) All() ([]*User, error) {
	// EXAMPLE: Replace with your database query
	return []*User{}, nil
}

// Create returns a stub user. EXAMPLE: Replace with database insert.
func (r *usersRepo) Create(input any) (User, error) {
	// EXAMPLE: Replace with your database insert
