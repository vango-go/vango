...
// Prefer DangerouslySetInnerHTML for new code as it makes the security
...
// Null returns nil, representing explicit nothing in the component tree.
// Use this when you want to explicitly render nothing.
//
// Example:
//
...
// Empty returns an empty fragment that renders nothing.
// Unlike Null which returns nil, Empty returns a valid VNode
...
// Nothing is a legacy alias for Null.
// Prefer Null() for new code to match the spec naming.
func Nothing() *VNode {
	return Null()
}
